...
export default function Home() {
    ...
    try {
      if (location && location !== '') {
        ...
        const dataItems = [
          ...
          {title: "Banyak Sampah Diproses", content: "21.25 Kg", img: "/sampah diproses.png", increase: false, value: "2 Kg", percentage: "1,6"},
  ...
  function calculateGasHarian(data) {
    ...
    return {
      today: { gasProd: gasTodayProd, gasUsed: gasTodayUsed },
      yesterday: { gasProd: gasYesterdayProd, gasUsed: gasYesterdayUsed }
    };
  }
